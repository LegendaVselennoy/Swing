...
//              frame.setTitle("ImageProcessingTest");
...
/**
 * Этот фрейм содержит меню для загрузки изображения и выбора
 * различных его преобразований, а также компонент для показа итогового изображения
 */
