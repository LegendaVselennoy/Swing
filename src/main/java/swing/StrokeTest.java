...
/**
 * В этой программе демонстрируется различные виды обводки
 */
...
/**
 * В этом фрейме пользователь может выбрать стиль окончания и соединения линий обводки, а также увидеть
 * получающуюся в итоге линию обводки
 */
class StrokeTestFrame extends JFrame{
    ...
    /**
     * Создаёт кнопку-переключатель для выбора стиля окончания линии
    ...
    /**
     * Создаёт кнопку-переключатель для выбора стиля соединения линий
     * @param label Метка кнопки-переключателя
    ...
    /**
     * Создаёт кнопку-переключатель для выбора сплошных или пунктирных линий обводки
     * @param label Метка кнопки-переключателя
     * @param style Принимает логическое значение false, если линия сплошная, или логическое значение true, если линия пунктирная
     * @param group
     */
...
/**
 * Этот компонент рисует две соединённые линии, используя разные объекты обводки и давая
 * пользователю возможность перетаскивать три точки, определяющие линии обводки
 */
class StrokeComponent extends JComponent{
    ...
    public void paintComponent(Graphics g){
        ...
        if (dash){
            ...
            float[] dashPattern={10F,10F,10F,10F,10F,
                    10F,30F,10F,30F,10F,30F,10F,
     ...
     * если линии сплошные, или логическое значение true, если линии пунктирные
     */
